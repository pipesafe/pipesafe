...
const dailyEventSummaryPipeline = new Pipeline<EventSchema>()
...
const conversionFunnelPipeline = new Pipeline<EventSchema>()
...
const geographicAnalysisPipeline = new Pipeline<EventSchema>()
...
const devicePerformancePipeline = new Pipeline<SessionSchema>()
...
const productPerformancePipeline = new Pipeline<EventSchema>()
