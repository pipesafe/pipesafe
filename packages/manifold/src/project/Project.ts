/**
 * Project - DAG Orchestrator for Models
 *
...
export type RunOptions = {
  ...
  dryRun?: boolean;
  /** MongoDB client (falls back to pipesafe singleton) */
  client?: MongoClient;
...
export class Project {
  ...
  private readonly models: Map<string, Model<any, any, any, any>>;
  ...
  getModel<TName extends string>(
    name: TName
  ): Model<TName, any, any, any> | undefined {
    return this.models.get(name) as Model<TName, any, any, any> | undefined;
  }

  /**
   * Get all models.
   */
  getModels(): Model<any, any, any, any>[] {
  ...
  async run(options: RunOptions = {}): Promise<ProjectRunResult> {
    ...
    // Get MongoDB client
    const mongoClient = client ?? pipesafe.client;
    if (!mongoClient) {
      throw new Error(
