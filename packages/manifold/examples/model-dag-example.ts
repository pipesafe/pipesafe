/**
 * Example: DAG Pipeline Composition with Model and Project
 *
...
const UsersCollection = new Collection<User>({
 ...
 */
const enrichedUserActivity = new Model({
...
// await pipesafe.connect("mongodb://localhost:27017");
